...
parameter and increasing optical depth through the wind. In general, we expect
scattering and ionization changes to scale as $\rho$, whereas recombination
emission scales as $\rho^2$. Wider launch radii and opening angles would lead 
to a larger emitting volume, but this would be moderated by a decrease in density for a fixed mass-loss rate. 
