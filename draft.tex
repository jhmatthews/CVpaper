...
%This is important when modeling features  such as the Balmer lines and also recombination {\sl continuum} emission. 
...
effect.   
% {\bf - ksl - I don't actually like the previous sentence.  
% We should some how say we want to study a few parameters that we think with help,
% without saying that something is beyond the scope}  
In particular, this
