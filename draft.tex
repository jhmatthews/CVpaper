...
{\bf NOTE JM: This abstract is a few lines longer than I would like- 
...
{\bf NOTEJM: I've included a reference to a paper on IP Peg here
...
{\bf NOTE CK: WHAT ARE THE PARTICULAR SETS OF PARAMETERS BEING ADOPTED HERE?}
}
\label{tests}
\end{figure}
\nocite{osterbrock}
...
$\dot{M}_{wind}$. 
{\bf NOTE CK: I'm still not sure I understand the formula
...
conclusions. 
{\bf NOTE CK: Is this true? Do we want to say anything else, e.g. that we'll
...
\begin{figure} %fullpage
\centering
\includegraphics[width=0.8\textwidth]{figures/3by3_grid_balmer.eps}  
