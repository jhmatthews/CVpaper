...
axvspan(3100,3646, facecolor='0.7', alpha=0.5)
...
labels = [r"He~\textsc{i}",r"He~\textsc{i}",r"He~\textsc{i}",
          r"He~\textsc{ii}",r"He~\textsc{ii}",
          r"H$\alpha$",r"H$\beta$", r"H$\gamma$", r"H$\delta$"]

offset = [0,0,0,0,-19,-19,-19,0,0,0,0]
vlines(lines,10,20, linewidth=2)
#vlines(heii,1,2.0, linewidth=2)

i = 0
for l in lines:
	text(l+20, 20, labels[i])
	i+=1
...
# finally, save
savefig("../../figures/salt_spectrum_rwtri_v_model.eps", bbox_inches = "tight")
savefig("salt_spectrum_rwtri_v_model.png")
